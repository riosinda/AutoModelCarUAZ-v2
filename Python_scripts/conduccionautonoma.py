...
class LaneDetector:
    ...
    def process(self, image):
        ...
        _,smooth_gray = cv2.threshold(image,180,255,cv2.THRESH_BINARY) #cv2.adaptativeThreshold(image,255,cv2.ADAPTIVE_THRESH_GAUSSIAN_C,cv2.THRESH_BINARY+cv2.THRESH_OTSU,11,2)
...
class image_converter:
    ...
    def callback_img(self,data):
        ...
        try:
            ...
            crop_img = cv_image[315:500, 0:620]
